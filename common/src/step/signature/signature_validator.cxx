...
#include "step/signature/signature_parser.hxx"
#include "step/signature/signature_xmlsec_adaptor.hxx"
...
bool CheckObjectID(
    const common::signature::SignatureData& signature_data) {
...
bool CheckProfileURI(const common::signature::SignatureData& signature_data) {
...
bool CheckReference(const common::signature::SignatureData& signature_data) {

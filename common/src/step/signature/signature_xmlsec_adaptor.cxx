...
class XmlSecContext {
 public:
  static void GetExtractedPath(const common::signature::SignatureData& data);
  static xmlSecKeysMngrPtr LoadTrustedCerts(
      const common::signature::SignatureData& signature_data);
  static bool VerifyFile(
      xmlSecKeysMngrPtr mngr, const common::signature::SignatureData& data);
...
void XmlSecContext::GetExtractedPath(
    const common::signature::SignatureData& data) {

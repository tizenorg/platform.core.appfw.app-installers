 ...
 */
class VersionAtLeastSpec : public composite {
 public:
 ...
 *        requirement
 */
class CertSpec : public composite {
 public:
 ...
 *        requirement
 */
class BackgroundSuptSpec : public composite {
 public:
  bool IsSatisfiedBy(const wgt_sec::BackgroundCatSpecTest &candidate) override {
 ...
 */
class KnownValueSpec : public composite {
 public:
 ...
 *        were parsed in background-category elements
 */
class UnknownValueSpec : public composite {
 public:
 ...
 */
class SystemValueSpec : public composite {
 public:
  bool IsSatisfiedBy(const wgt_sec::BackgroundCatSpecTest &candidate) override {
 ...
 */
class EmptyValueSpec : public composite {
 public:
  bool IsSatisfiedBy(const wgt_sec::BackgroundCatSpecTest &candidate) override {

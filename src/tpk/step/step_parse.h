...
class StepParse : public common_installer::Step {
 ...
 private:
  ...
  template <typename T> bool FillIconPaths(T* manifest);
  ...
  template <typename T> bool FillAppControl(T* manifest);
  template <typename T> bool FillDataControl(T* manifest);
  template <typename T> bool FillLabel(T* manifest);

...
#ifndef WIDGET_MANIFEST_PARSER_MANIFEST_HANDLERS_APP_CONTROL_HANDLER_H_
#define WIDGET_MANIFEST_PARSER_MANIFEST_HANDLERS_APP_CONTROL_HANDLER_H_
...
#endif  // WIDGET_MANIFEST_PARSER_MANIFEST_HANDLERS_APP_CONTROL_HANDLER_H_

...
#ifndef COMMON_STEP_SECURITY_STEP_CHECK_OLD_CERTIFICATE_H_
#define COMMON_STEP_SECURITY_STEP_CHECK_OLD_CERTIFICATE_H_
 ...
 */
__attribute__ ((visibility ("default"))) class StepCheckOldCertificate : public Step {
 public:
  using Step::Step;

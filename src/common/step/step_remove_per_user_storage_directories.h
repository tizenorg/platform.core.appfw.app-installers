...
#ifndef COMMON_STEP_STEP_REMOVE_PER_USER_STORAGE_DIRECTORIES_H_
#define COMMON_STEP_STEP_REMOVE_PER_USER_STORAGE_DIRECTORIES_H_
...
#endif  // COMMON_STEP_STEP_REMOVE_PER_USER_STORAGE_DIRECTORIES_H_

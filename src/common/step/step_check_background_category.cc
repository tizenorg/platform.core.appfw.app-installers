...
bool BaseStepCheckBackgroundCategory::ShouldSendAll(
    utils::VersionNumber const& version,
...
void BaseStepCheckBackgroundCategory::GetBackgroundCategories(
...
ci::Step::Status BaseStepCheckBackgroundCategory::DoSendFail(
    ci::PrivilegeLevel privilege,
    BackgroundCatSet const& background_categories) {
...
void BaseStepCheckBackgroundCategory::DoSendAll(
    utils::VersionNumber const& version,
    bool background_support,
    ci::PrivilegeLevel privilege,
    BackgroundCatSet const& background_categories,
...
void BaseStepCheckBackgroundCategory::DoSendSystem(
    ci::PrivilegeLevel privilege,
    BackgroundCatSet const& background_categories,
    application_x * app) {
...
void BaseStepCheckBackgroundCategory::DoSendKnown(
    utils::VersionNumber const& version,
    bool background_support,
    ci::PrivilegeLevel privilege,
    BackgroundCatSet const& background_categories,
...
void BaseStepCheckBackgroundCategory::DoSendUnknown(
    ci::PrivilegeLevel privilege,
    BackgroundCatSet const& background_categories,
    application_x * app) {
...
void BaseStepCheckBackgroundCategory::RemoveContextBackgroundCategories(
    application_x * app) {
  g_list_free_full(app->background_category, g_free);
  app->background_category = nullptr;
}

ci::Step::Status BaseStepCheckBackgroundCategory::process() {
  ...
  for (application_x* app :
    ...
    DoSendFail(privilege_level, background_cat);

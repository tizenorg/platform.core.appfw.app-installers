...
#ifndef COMMON_STEP_FILESYSTEM_STEP_RECOVER_PACKAGE_STORAGE_H_
#define COMMON_STEP_FILESYSTEM_STEP_RECOVER_PACKAGE_STORAGE_H_
...
#endif  // COMMON_STEP_FILESYSTEM_STEP_RECOVER_PACKAGE_STORAGE_H_

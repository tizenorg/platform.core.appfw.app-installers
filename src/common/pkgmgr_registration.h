 ...
 */
bool RegisterAppInPkgmgr(ManifestXWrapperPtr& manifest,
 ...
 * \return true if success
 */
bool UpgradeAppInPkgmgr(ManifestXWrapperPtr& manifest,
                        const boost::filesystem::path& xml_path,
                        const std::string& pkgid,
                        const CertificateInfo& cert_info,
                        uid_t uid,
 ...
 * \return true if success
 */
bool UnregisterAppInPkgmgr(ManifestXWrapperPtr& manifest,
                           const boost::filesystem::path& xml_path,
                           const std::string& pkgid,
                           uid_t uid,
                           RequestMode request_mode);

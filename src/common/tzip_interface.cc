...
namespace {
const char TZIP_BUS_NAME[] = "org.tizen.system.deviced";
const char TZIP_OBJECT_PATH[] = "/Org/Tizen/System/DeviceD/Tzip";
const char TZIP_INTERFACE_NAME[] = "org.tizen.system.deviced.Tzip";
const char TZIP_MOUNT_METHOD[] = "Mount";
const char TZIP_UNMOUNT_METHOD[] = "Unmount";
const char TZIP_IS_MOUNTED_METHOD[] = "IsMounted";
const int TZIP_MOUNT_MAXIMUM_RETRY_CNT = 15;
}
 ...
 public:
  ...
  bool MountZip(const boost::filesystem::path& zip_path) {
    ...
    std::unique_ptr<DBusMessage, void(*)(DBusMessage*)> msg(
        dbus_message_new_method_call(TZIP_BUS_NAME, TZIP_OBJECT_PATH,
                                     TZIP_INTERFACE_NAME,
                                     TZIP_MOUNT_METHOD),
                                     DBusMessageDeleter);
    if (!msg) {

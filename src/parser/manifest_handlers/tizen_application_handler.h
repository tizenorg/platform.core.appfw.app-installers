...
#ifndef PARSER_MANIFEST_HANDLERS_TIZEN_APPLICATION_HANDLER_H_
#define PARSER_MANIFEST_HANDLERS_TIZEN_APPLICATION_HANDLER_H_
...
#endif  // PARSER_MANIFEST_HANDLERS_TIZEN_APPLICATION_HANDLER_H_

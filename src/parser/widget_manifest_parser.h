...
#ifndef PARSER_WIDGET_MANIFEST_PARSER_H_
#define PARSER_WIDGET_MANIFEST_PARSER_H_
...
class WidgetManifestParser {
 ...
 private:
  ...
  bool ExtractIconSrc(const utils::Value& dict,
...
#endif  // PARSER_WIDGET_MANIFEST_PARSER_H_
